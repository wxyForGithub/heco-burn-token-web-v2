...
const messages = {
  zh: {
    ...
    permission: '权限申请中',
    power1: '算力',
    recommTip: 'hbt社区推荐使用owncoin钱包，更安全更方便',
    projectStep: 'hbt项目进展动态',
    levelTip1: '例如手续费20%，转账100个，转出方扣除125个，接收方获得100个，25个销毁。',
    levelTip2: 'HBT手续费规则：',
  ...
  en: {
    power: 'My Power HBT',
    balance: 'My Balance',
    supply: 'Total Circulation',
    burnToken: 'Contract Address',
    levelDesc: 'Level',
    ...
    rewardTotal: 'Accumulated Invitation Revenue',
    ...
    totalInvite: 'Total invited {amount}',
    myAddress: 'Address',
    ...
    receiveIncome: 'Receive earnings',
    ...
    invitePlaceholder:'Invitee Address',
    ...
    transfromFeeDesc: 'Transfer fee destruction function',
    ok: 'OK',
    burnTips: 'Make sure that after submission your burning balance will be destroyed into 3 times the arithmetic power',
    burnTips2: 'When burning, it will burn a certain proportion of {tokenSymbol}, which is determined by the community dao',
    leveTips: 'Level Lv2, yielding a maximum of {time} times',
    pledgeTips: 'Users with a level of less than V1 can only deposit {symbol} with the least {minAmount} pledge',
    noPower: 'You do not currently have the power to calculate',
    ...
    power1: 'Arithmetic',
    recommTip: 'The HBT community recommends using owncoin wallet, safer and more convenient',
    projectStep: 'HBT Project Progress Update',
    levelTip1: 'For example, the handling fee is 20%, transfer 100, the transferring party deducts 125, the receiving party gets 100 and 25 are destroyed.',
    levelTip2: 'HBT handling fee rule：',
